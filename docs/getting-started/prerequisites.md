...
## Required Tools
> CONTENT: Checklist format with version verification commands for each tool:
...
> CONTENT: Links to official installation docs for each tool on Linux, macOS, and Windows.
