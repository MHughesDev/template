...
<!-- CROSS-REFERENCES -->
<!-- - Referenced by: AGENTS.md §9, CONTRIBUTING.md, prompts/queue_agent_prompt.md -->
...
- `prompts/queue_agent_prompt.md` — Executable behavior contract for agents (must read before processing)
- `docs/queue/QUEUE_SPLIT_TRIGGERS.md` — Quick reference card for split triggers (when a row must be decomposed)
