...
2. `docs/queue/QUEUE_INSTRUCTIONS.md` lifecycle language still includes agent-archives wording in parts, while executor prompts enforce operator-only archive.
...
3. `docs/queue/QUEUE_INSTRUCTIONS.md` and `prompts/queue_agent_prompt.md`
