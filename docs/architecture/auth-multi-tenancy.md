...
> CONTENT: One paragraph describing the auth-multi-tenancy architecture in this repository. Reference relevant spec sections (§12-§14) and implementation patterns.
