...
> CONTENT: This document covers evolving-from-incidents for human maintainers supervising agent work. Per spec §9.3, this file must address: how humans supervise agents, review AI diffs, audit PRs, ratchet quality, and evolve from incidents.
