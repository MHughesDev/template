...
> CONTENT: This package contains shared Pydantic models that constitute the API contract between bounded contexts and between the API and external clients. Root AGENTS.md remains supreme for all repo-wide policy.

## Backward Compatibility Rules

> CONTENT: The most critical constraint for this package:
...
> CONTENT: Current version: v1 (all models are in the default namespace). When breaking changes are unavoidable: create packages/contracts/v2/ namespace and migrate clients deliberately with a deprecation period.

## Testing Contract Changes

> CONTENT: Any change to models in this package requires:
