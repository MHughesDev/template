...
**Canonical specification (merged):** this document is **`downloadable.md`**. The file **`spec.md`** is a thin alias that points here so older links and automation keep working.

**Download:** use **`downloadable.md`** as the single full specification to copy, version, or attach to releases.
...
├── pyproject.toml
├── downloadable.md             # Canonical full specification (this document)
├── spec.md                     # Alias / pointer to downloadable.md
...
2. **Instruction hierarchy** — short pointer to this spec’s precedence table; link to **`downloadable.md`** (canonical full spec).  
...
- [ ] **`downloadable.md`** (canonical full spec) and **`spec.md`** (alias) present.  
...
- [ ] **README.md** quickstart linking **`AGENTS.md`**, **`downloadable.md`** (and **`spec.md`** if kept as alias), **`docs/`**.
...
| Item | Value |
|------|--------|
| **Canonical spec file** | `downloadable.md` (`spec.md` → alias) |
| **Version** | 2.0 |
