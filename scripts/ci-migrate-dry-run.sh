...
# Local parity with CI job migrate-dry-run (.github/workflows/ci.yml): SQLite SQL preview + apply.
...
# Same URL shape as CI: cwd is repo root; ./file is a valid path (three slashes after scheme).
