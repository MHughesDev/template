...
**Purpose:** How to perform backup and restore drills: database dumps, volume snapshots, verification procedures.

## Purpose

How to perform backup and restore drills: database dumps, volume snapshots, verification procedures.
