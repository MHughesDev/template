...
**Purpose:** How to configure Kubernetes probes: liveness, readiness, startup — paths, thresholds, dependency checks.

## Purpose

How to configure Kubernetes probes: liveness, readiness, startup — paths, thresholds, dependency checks.
