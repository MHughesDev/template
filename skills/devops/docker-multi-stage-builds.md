...
**Purpose:** How to build efficient multi-stage Docker images: builder/runner stages, non-root user, layer caching, healthcheck.

## Purpose

How to build efficient multi-stage Docker images: builder/runner stages, non-root user, layer caching, healthcheck.
