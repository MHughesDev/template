...
Instructions for agents on how to use this index:
...
Brief description of the §6.2 required sections every skill must have:
...
Table of all init skills. Columns: Skill file, One-line description, Machinery. Rows:
...
Table of repo-governance skills:
...
Table of AI skills (all optional):
...
Table of frontend skills (all optional):
...
Brief reference to docs/procedures/update-or-create-skill.md. Summary:
