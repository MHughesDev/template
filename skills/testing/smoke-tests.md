...
**Purpose:** How to write and run smoke tests: health check, critical path verification, post-deploy validation.

## Purpose

How to write and run smoke tests: health check, critical path verification, post-deploy validation.
