...
**Purpose:** How to write API contract tests: request/response schema validation, OpenAPI spec alignment.

## Purpose

How to write API contract tests: request/response schema validation, OpenAPI spec alignment.
