...
**Purpose:** How to add regression tests after bug fixes: capture the bug, write the test, verify the fix.

## Purpose

How to add regression tests after bug fixes: capture the bug, write the test, verify the fix.
