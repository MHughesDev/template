...
**Purpose:** How to test async FastAPI code: `pytest-asyncio`, `httpx.AsyncClient`, event loop fixtures.

## Purpose

How to test async FastAPI code: `pytest-asyncio`, `httpx.AsyncClient`, event loop fixtures.
