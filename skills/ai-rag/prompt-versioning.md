# skills/ai-rag/prompt-versioning.md
...
> PURPOSE: [OPTIONAL] TODO — Composer 2 implements full §6.2 skill content for prompt-versioning in the AI/RAG domain. Only relevant when the ai-rag profile is enabled.
