# skills/ai-rag/chromadb-ingestion.md
...
> PURPOSE: [OPTIONAL] TODO — Composer 2 implements full §6.2 skill content for chromadb-ingestion in the AI/RAG domain. Only relevant when the ai-rag profile is enabled.
