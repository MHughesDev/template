# skills/ai-rag/ai-safety-review.md
...
> PURPOSE: [OPTIONAL] TODO — Composer 2 implements full §6.2 skill content for ai-safety-review in the AI/RAG domain. Only relevant when the ai-rag profile is enabled.
