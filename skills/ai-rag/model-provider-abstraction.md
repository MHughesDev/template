# skills/ai-rag/model-provider-abstraction.md
...
> PURPOSE: [OPTIONAL] TODO — Composer 2 implements full §6.2 skill content for model-provider-abstraction in the AI/RAG domain. Only relevant when the ai-rag profile is enabled.
