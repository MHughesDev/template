...
## Step-by-Step Method
Generate or configure an API client; call authenticated endpoints; handle 401 refresh if applicable.

## Command Examples
`npm run dev` (web) or `npx expo start` (mobile); curl API with Bearer token.
