...
> CONTENT: One paragraph describing what this skill enables agents to do in the configuration-management domain. Reference relevant spec sections and link to FastAPI/SQLAlchemy/K8s documentation as appropriate.
