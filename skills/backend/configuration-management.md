...
**Purpose:** How to add new configuration: `.env.example`, `config.py`, validation, documentation.

## Purpose

How to add new configuration: `.env.example`, `config.py`, validation, documentation.
