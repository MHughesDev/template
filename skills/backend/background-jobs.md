...
**Purpose:** How to define and register background jobs via `packages/tasks` interfaces.

## Purpose

How to define and register background jobs via `packages/tasks` interfaces.
