...
**Purpose:** How to define and use stable error codes: error registry, response shapes, client documentation.

## Purpose

How to define and use stable error codes: error registry, response shapes, client documentation.
