...
**Purpose:** How to design idempotent task handlers: idempotency keys, deduplication, safe retries.

## Purpose

How to design idempotent task handlers: idempotency keys, deduplication, safe retries.
