...
**Purpose:** How to enable the worker profile, connect to broker (Redis/Rabbit), and verify job execution.

## Purpose

How to enable the worker profile, connect to broker (Redis/Rabbit), and verify job execution.
