...
**Purpose:** How to expose Prometheus-compatible metrics: `/metrics` endpoint, custom counters/histograms, network policy.

## Purpose

How to expose Prometheus-compatible metrics: `/metrics` endpoint, custom counters/histograms, network policy.
