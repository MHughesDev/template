...
**Purpose:** How to add OpenTelemetry tracing: span creation, context propagation, exporter configuration.

## Purpose

How to add OpenTelemetry tracing: span creation, context propagation, exporter configuration.
