...
After running queue intelligence:
...
docs/procedures/start-queue-item.md, docs/procedures/handle-blocked-work.md, docs/procedures/add-queue-category.md
...
.cursor/rules/queue.md (queue invariants and dependency checking)

## Machinery

`skills/agent-ops/queue-intelligence.py` — the intelligence engine. See that file's docstring for full API. Key functions:
