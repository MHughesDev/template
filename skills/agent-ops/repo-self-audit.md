...
Include the full audit summary in the PR description. State: "Audit run: make audit:self — PASS/FAIL. [N] blocking, [N] warning findings."

## Related Procedures

docs/procedures/validate-change.md, docs/repo-governance/audits.md
