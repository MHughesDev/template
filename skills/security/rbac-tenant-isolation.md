...
**Purpose:** How to verify RBAC and tenant isolation: test patterns, middleware checks, query scoping.

## Purpose

How to verify RBAC and tenant isolation: test patterns, middleware checks, query scoping.
