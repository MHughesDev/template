...
**Purpose:** How to audit the codebase for secure defaults: auth enabled, CORS restrictive, debug off in prod, etc.

## Purpose

How to audit the codebase for secure defaults: auth enabled, CORS restrictive, debug off in prod, etc.
