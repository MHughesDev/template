...
**Purpose:** How to generate and publish SBOMs and attestations for container images.

## Purpose

How to generate and publish SBOMs and attestations for container images.
