...
Standard mandatory skill search preamble. MUST read skills/repo-governance/authoring-cursor-rules.md before creating any rule.
...
Per docs/procedures/update-or-create-rule.md:
