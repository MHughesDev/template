...
Standard mandatory skill search preamble. Specifically, run make skills:list and read all security skills before reviewing any security-adjacent code.
...
The review document must include these sections:
