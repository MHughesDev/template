...
Standard mandatory skill search preamble. Read skills/devops/environment-configuration.md before starting.
...
Point to docs/troubleshooting/common-issues.md for the most common issues. Common setup failures:
